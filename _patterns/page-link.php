...
<!-- wp:group {"align":"full","style":{"spacing":{"margin":{"top":"0px"},"padding":{"left":"30px","top":"var:preset|spacing|x-large","right":"30px","bottom":"var:preset|spacing|x-large"}}},"className":"is-style-full-height","layout":{"inherit":true,"type":"constrained"}} -->
  <div class="wp-block-group alignfull is-style-full-height" style="margin-top:0px;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
      ...
      <div class="wp-block-group">
        ...
        <!-- wp:image {"align":"center","id":3489,"width":120,"height":120,"sizeSlug":"full","linkDestination":"none","className":"is-style-rounded"} -->
          <figure class="wp-block-image aligncenter size-full is-resized is-style-rounded">
            <img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample-black_800x800.jpg'; ?>"  alt="' . esc_attr__( 'Sample Image', 'mackman' ); ?>" class="wp-image-3489" width="120" height="120"/>
          </figure>
        <!-- /wp:image -->

          ...
          <div class="wp-block-column">
            ...
            <!-- wp:image {"id":242,"sizeSlug":"full","linkDestination":"none"} -->
              <figure class="wp-block-image size-full">
                <img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/holding.jpg'; ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'mackman' ); ?>" class=""/>
              </figure>
            <!-- /wp:image -->
              ...
              <div class="wp-block-buttons">
                ...
                <!-- wp:button {"style":{"border":{"radius":0}},"className":"is-style-outline-base"} -->
                  <div class="wp-block-button is-style-outline-base">
                    <a class="wp-block-button__link no-border-radius"><?php echo esc_html__( 'Learn More', 'mackman' ); ?></a>
                  </div>
                <!-- /wp:button -->

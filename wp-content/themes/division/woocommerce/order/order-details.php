...
?>
<h3 class="content-separator bk_margin_15"><span class="title"><?php _e( 'Order Details', 'woocommerce' ); ?></span></h3>
...
<header>
	<h3 class="content-separator"><span class="title"><?php _e( 'Customer details', 'woocommerce' ); ?></span></h3>
</header>
...
<?php endif; ?>
		...
		<header class="title">
			<h3 class="content-separator"><span class="title"><?php _e( 'Billing Address', 'woocommerce' ); ?></span></h3>
		</header>
		<address><p>
			<?php
...
<?php if (get_option('woocommerce_ship_to_billing_address_only')=='no') : ?>
	...
	<div class="col-2">
		...
		<header class="title">
			<h3 class="content-separator"><span class="title"><?php _e( 'Shipping Address', 'woocommerce' ); ?></span></h3>
		</header>
		<address><p>
			<?php

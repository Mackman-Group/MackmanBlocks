 ...
 * Slug: mackman/general-team-four-columns-contrast-background
 * Categories: team
 * Viewport Width: 1280
 */
?>
<!-- wp:group {"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|base"}}},"spacing":{"margin":{"top":"0px"},"padding":{"top":"var:preset|spacing|x-large","right":"30px","bottom":"var:preset|spacing|x-large","left":"30px"}}},"backgroundColor":"contrast","textColor":"base","className":"has-background-color","layout":{"inherit":true,"type":"constrained"}} -->
  <div class="wp-block-group alignfull has-background-color has-base-color has-contrast-background-color has-text-color has-background has-link-color" style="margin-top:0px;padding-top:var(--wp--preset--spacing--x-large);padding-right:30px;padding-bottom:var(--wp--preset--spacing--x-large);padding-left:30px">
    ...
    <!-- wp:heading {"textAlign":"center","fontSize":"x-large"} -->
      <h2 class="has-text-align-center has-x-large-font-size" id="our-team"><?php echo esc_html__( 'Our Team', 'mackman' ); ?></h2>
    <!-- /wp:heading -->
    
    <!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}}} -->
      <p class="has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'The people who are ready to serve you.', 'mackman' ); ?></p>
    <!-- /wp:paragraph -->
      ...
      <div class="wp-block-columns alignwide">
        ...
        <!-- wp:column -->
          <div class="wp-block-column">
            ...
            <!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
              <h3 class="has-text-align-center has-medium-font-size" id="member-name-1"><?php echo esc_html__( 'Member Name', 'mackman' ); ?></h3>
            <!-- /wp:heading -->
            ...
            <!-- wp:paragraph {"align":"center"} -->
              <p class="has-text-align-center"><a href="#"><?php echo esc_html__( 'View profile', 'mackman' ); ?></a>.</p>
            <!-- /wp:paragraph -->
        ...
        <!-- wp:column -->
          <div class="wp-block-column">
            ...
            <!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
              <h3 class="has-text-align-center has-medium-font-size" id="member-name-2"><?php echo esc_html__( 'Member Name', 'mackman' ); ?></h3>
            <!-- /wp:heading -->
        ...
        <!-- wp:column -->
          <div class="wp-block-column">
            ...
            <!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
              <h3 class="has-text-align-center has-medium-font-size" id="member-name-3"><?php echo esc_html__( 'Member Name', 'mackman' ); ?></h3>
            <!-- /wp:heading -->
        ...
        <!-- wp:column -->
          <div class="wp-block-column">
            ...
            <!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
              <h3 class="has-text-align-center has-medium-font-size" id="member-name-4"><?php echo esc_html__( 'Member Name', 'mackman' ); ?></h3>
            <!-- /wp:heading -->

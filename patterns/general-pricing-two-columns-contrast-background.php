 ...
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"margin":{"top":"0px"},"padding":{"top":"var:preset|spacing|x-large","right":"30px","bottom":"var:preset|spacing|x-large","left":"30px"}}},"backgroundColor":"contrast","textColor":"base","className":"has-background-color","layout":{"inherit":false,"contentSize":"800px","type":"constrained"}} -->
...
<p class="has-text-align-center"><?php echo esc_html__( 'Create a two-column table, wide-width', 'mackman' ); ?> (800px).</p>
<!-- /wp:paragraph -->

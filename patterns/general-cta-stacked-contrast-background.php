 ...
 * Slug: mackman/general-cta-stacked-contrast-background
...
<div class="wp-block-button is-style-outline-base"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Get in Touch', 'mackman' ); ?> →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
